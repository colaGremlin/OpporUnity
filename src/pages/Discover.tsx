...
<div className="flex flex-grow">
  ...
  filterOpen
    ? 'fixed top-[136px] bottom-0 left-0 z-20 bg-scholarship-background border-r border-white/10 w-full md:w-80 transform translate-x-0'
    : 'fixed top-[136px] bottom-0 left-0 z-20 bg-scholarship-background border-r border-white/10 w-full md:w-80 transform -translate-x-full md:translate-x-0 md:w-0 md:opacity-0 md:invisible'
}`}>
  <FilterSidebar
    isOpen={filterOpen}
    onClose={() => setFilterOpen(false)}
